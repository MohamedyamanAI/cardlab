    ...
    <>
      <BlurFade delay={0}>
        <div className="text-center">
          <h1 className="text-2xl font-bold text-white">Sign in to Cardlab</h1>
      ...
      <BlurFade delay={0.3}>
        <button
          ...
          className="flex w-full items-center justify-center gap-2 rounded-4xl border border-white/10 bg-white/5 px-3 py-2.5 text-sm font-medium text-white transition-all hover:border-white/20 hover:bg-white/10"
        >
