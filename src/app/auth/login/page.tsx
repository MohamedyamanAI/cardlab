  ...
  return (
    <>
      <div className="text-center">
        <h1 className="text-2xl font-bold">Sign in to Cardlab</h1>
      ...
      <button
        ...
        className="flex w-full items-center justify-center gap-2 rounded-md border border-foreground/20 px-3 py-2 text-sm font-medium transition-colors hover:bg-foreground/5"
      >
