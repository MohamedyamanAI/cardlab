    ...
    <SheetPortal>
      ...
      <SheetPrimitive.Content
        ...
        className={cn(
          ...
          !inset && "data-[side=left]:w-3/4 data-[side=right]:w-3/4",
          // Default max-width (only when not inset)
          !inset && "data-[side=left]:sm:max-w-sm data-[side=right]:sm:max-w-sm",
          // Animations
          ...
          // Inset: floating panel with rounded corners and gap
          inset && "m-3 rounded-xl border data-[side=right]:h-[calc(100%-1.5rem)] data-[side=left]:h-[calc(100%-1.5rem)]",
          className
        )}
        {...props}
      >
